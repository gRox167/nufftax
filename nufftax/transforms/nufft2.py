...
from ..core.spread import _interp_1d_dispatch, _interp_2d_dispatch, _interp_3d_dispatch
...
def nufft3d2(
    ...
    # Step 4: Interpolate to nonuniform points
    c = _interp_3d_dispatch(x_normalized, y_normalized, z_normalized, fw, kernel_params)
